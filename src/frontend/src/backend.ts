...
export class Backend implements backendInterface {
    ...
    async getGlobalHiScore(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getGlobalHiScore();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getUserHiScore(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserHiScore(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
